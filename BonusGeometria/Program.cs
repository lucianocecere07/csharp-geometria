...
ossia tanti “—” (due trattini) orizzontali quanto è grande la sua base e tanti ‘|’ verticali quanto la sua altezza.
*/
...
BonusRettangolo rettangoloUtente = new BonusRettangolo();

//proprietà chieste all'utente (rettangolo uno)
Console.Write("inserisci la base del rettangolo: ");
rettangoloUtente.baseBonusRettangolo = int.Parse(Console.ReadLine());
Console.Write("inserisci l'altezza del rettangolo: ");
rettangoloUtente.altezzaBonusRettangolo = int.Parse(Console.ReadLine());

//spazio nella console
Console.WriteLine("");

//stampare disegno del rettangolo (bonus)
rettangoloUtente.DisegnoRettangolo();
...
//------------------------Prove------------------------//
/*
for (int i = 0; i < rettangoloUtente.altezzaBonusRettangolo; i++)
{
    Console.WriteLine("");
    Console.Write("|");

    for (int j = 0; j < rettangoloUtente.baseBonusRettangolo; j++)
    {
        Console.Write("--");
    }
    Console.WriteLine("");
